...
# 2. Open New Terminal
# 3. Select 'git bash'
# 4. Run `bash ci/install-2d-player-controller.sh`
...
REPO_URL="https://github.com/kirbycope/godot-2d-player-controller.git"
DIRECTORY="addons/2d_player_controller"
BRANCH="main"
...
mv addons/2d_player_controller ./  # Moves the directory up one level
